            ...
            <li class="sectors__start-top">
                <div style="background-image:url(/Storage/Statics/images/sector_04.jpg)" >
                    <div>
                        <h3 class="h6-like">
                            <a href="#" >
                                <span> E-Learning et Traitement des langues naturelles</span>
            ...
            <li class="sectors__start-bottom">
                <div style="background-image:url(/Storage/Statics/images/sector_05.jpg)" >
                    <div>
                        <h3 class="h6-like">
                            <a href="#">
                                <span>Traitement Automatique de la parole et du locuteur</span>
                                <span>5 enseignant</span>
                            </a>
                        </h3>
                    </div>
                </div>
            ...
            <li class="sectors__middle-top">
                <div style="background-image:url(/Storage/Statics/images/sector_02.jpg)" >
                    <div>
                        <h3 class="h6-like">
                            <a href="#" >
                                <span>Datamining et aide à la décision</span>
                                <span>2 enseignant</span>
                            </a>
                        </h3>
                    </div>
                </div>
            ...
            <li class="sectors__middle-bottom">
                <div style="background-image:url(/Storage/Statics/images/sector_06.jpg)" >
                    <div>
                        <h3 class="h6-like">
                            <a href="#" >
                                <span>Systèmes embarqués et Théorie de codes</span>
                                <span>1 enseignant</span>
                            </a>
                        </h3>
                    </div>
                </div>
