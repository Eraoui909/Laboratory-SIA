...
<div class="ha-footer">
    ...
    <div class="ha-footer-head">
        ...
        <div class="ha-footer-head-sec ha-footer-head-sec1" style="width: 150%">
            <h3>SIA LAB</h3>
            <img src="<?php echo $GLOBAL_DIR ?>/Storage/Statics/images/logoLaboFst.png" width="200px" height="100px">
        ...
        <div class="ha-footer-head-sec ha-footer-head-sec4">
            ...
            <ul>
                <li>
                    <img src="<?php echo $GLOBAL_DIR ?>/Storage/Statics/images/u-picardie.png"  width="30px" height="30px" style="border-radius: 50%">
                    <a href="https://www.u-picardie.fr/"  target="_blank">  UPJV, Amiens France</a>
                </li>
                <li>
                    <img src="<?php echo $GLOBAL_DIR ?>/Storage/Statics/images/umonpellier.png"  width="30px" height="30px" style="border-radius: 50%">
                    <a href="https://www.umontpellier.fr/en/"  target="_blank">  Université de Montpelier</a>
                </li>
                <li>
                    <img src="<?php echo $GLOBAL_DIR ?>/Storage/Statics/images/CNR-ILC_Logo.png"  width="30px" height="30px" style="border-radius: 50%">
                    <a href="http://www.ilc.cnr.it/"  target="_blank">  ILC-CNR de Pise en Italie</a>
                </li>

                <li>
                    <img src="<?php echo $GLOBAL_DIR ?>/Storage/Statics/images/Logo_CHU-final.png"  width="30px" height="30px" style="border-radius: 50%">
                    <a href="http://www.chu-fes.ma/en/home-en/"  target="_blank">  CHU de FES</a>
                </li>

                <li>
                    <img src="<?php echo $GLOBAL_DIR ?>/Storage/Statics/images/ul-logo.jpg"  width="30px" height="30px" style="border-radius: 50%">
                    <a href="https://www.ul.ie/"  target="_blank">  Université de Limerick Irlande</a>
                </li>

                <li>
                    <img src="<?php echo $GLOBAL_DIR ?>/Storage/Statics/images/fsdm-logo.png"  width="30px" height="30px" style="border-radius: 50%">
                    <a href="http://www.fsdmfes.ac.ma/"  target="_blank"> Laboratoire IMS de FSDM de Fes</a>
                </li>

                <li>
                    <img src="<?php echo $GLOBAL_DIR ?>/Storage/Statics/images/BL_logo.png"  width="30px" height="30px" style="border-radius: 50%">
                    <a href="https://www.berger-levrault.com/ma/"  target="_blank"> Entreprise Berger-Levrault Montpelier</a>
                </li>

                <li>
                    <img src="<?php echo $GLOBAL_DIR ?>/Storage/Statics/images/amis-logo.png"  width="30px" height="30px" style="border-radius: 50%">
