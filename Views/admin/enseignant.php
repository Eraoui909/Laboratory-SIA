...
<div class="content-wrapper">
    ...
    <div class="modal fade show" id="modal-modify-enseignant" style="display: none;background-color: #00000094; padding-right: 16px;" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-lg" id="modal-modify-enseignant">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Modifier Enseignant</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" id="modal-modify-enseignant-close">×</span>
                    </button>
                </div>
                <div class="contanier" style="width: 80%;margin: 10px auto;">
                    <div class="msg-modify-enseignant">
                ...
                <div class="modal-body">
                    <form action="/admin/enseignant/modify" class="form-modify-enseignat" method="post">
                        ...
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default" id="modal-modify-enseignant-close-btn" data-dismiss="modal">Close</button>
                ...
                <?php foreach ($data as $ens){ ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn-sm btn-danger btn-sm delete-enseignant-btn" data-id="<?php echo $ens['id'] ?>">
